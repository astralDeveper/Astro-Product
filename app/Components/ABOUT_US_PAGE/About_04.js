        ...
        <>
            <div className='container py-5 ' ref={containerRef}>
                <div className='row my-lg-5 '>
                    <div className='col-lg-12 col-sm-6 col-md-6  bg'>
                        <div className='abou-4-text '>
                            <h1 className=' text-white'>Our results speak for themselves</h1>
                        </div>
                    </div>
                    <div className='col-lg-4  col-sm-6 col-md-6 Abou-4-coun d-flex justify-content-center align-items-center mt-3'>
                        <div className='abou_4_card'>
                            <h1>
                                30x
                            </h1>
                            <p>
                                Growth of active merchants
                            </p>
                        </div>
                    </div>
                    <div className='col-lg-4  w col-sm-6 col-md-6 Abou-4-coun d-flex justify-content-center align-items-center mt-3'>
                        <div className='abou_4_card'>
                            <h1>
                                ${count}B
                            </h1>
